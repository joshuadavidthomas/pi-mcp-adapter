...
import { createMcpCallRenderer, renderMcpResult, summarizeDirectMcpCall, summarizeProxyMcpCall } from "./mcp-tool-renderer.js";
...
export default function mcpAdapter(pi: ExtensionAPI) {
  ...
  if (shouldRegisterProxyTool) {
    pi.registerTool({
      ...
      renderCall: createMcpCallRenderer("mcp", summarizeProxyMcpCall),
      renderResult: renderMcpResult,
